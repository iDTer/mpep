...
typedef struct IMCPCB imcpcb;

#define IMCP_LOG_OUTPUT			1
#define IMCP_LOG_INPUT			2
#define IMCP_LOG_SEND			4
#define IMCP_LOG_RECV			8
#define IMCP_LOG_IN_DATA		16
#define IMCP_LOG_IN_ACK			32
#define IMCP_LOG_IN_PROBE		64
#define IMCP_LOG_IN_WINS		128
#define IMCP_LOG_OUT_DATA		256
#define IMCP_LOG_OUT_ACK		512
#define IMCP_LOG_OUT_PROBE		1024
#define IMCP_LOG_OUT_WINS		2048
...
// create a new mcp control object, 'conv' must equal in two endpoint
// from the same connection. 'user' will be passed to the output callback
// output callback can be setup like this: 'mcp->output = my_udp_output'
imcpcb* imcp_create(IUINT32 conv, void *user);
